...
public class punto6 {
  public static void main(String[] args) {
	...
	int diff =Math.max(num1,num2)- Math.min(num1,num2); // obtengo la diferencia entre los dos numeros inresados por el usuario
	
	if (multiplo >= diff){
		System.out.println("");
		System.out.println("ATENCION!!");
		System.out.println("El multiplicador es mayor o igual a la diferencia entre los dos primeros");
		System.out.println("");
		    }
